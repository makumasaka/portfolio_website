      ...
      <div className="about-content">
        ...
        <div className="about-bottom">
          ...
          <nav className="about-links" aria-label="Contact links">
            <a href="https://github.com/makumasaka" target="_blank" rel="noopener noreferrer" title="Github" aria-label="Github">
            ...
            <a href="https://www.linkedin.com/in/makotomoseskumasaka/" target="_blank" rel="noopener noreferrer" title="LinkedIn" aria-label="LinkedIn">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
