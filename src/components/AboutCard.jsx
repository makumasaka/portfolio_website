      ...
      <div className="about-content">
        ...
        <div className="about-bottom">
          ...
          <nav className="about-links" aria-label="Contact links">
            <a href="mailto:hello@makotomoseskumasaka.com" title="Email" aria-label="Email">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                <rect x="2" y="4" width="20" height="16" rx="2" />
                <path d="M22 4L12 13 2 4" />
              </svg>
            </a>
            <a href="https://www.linkedin.com/in/makotokumasaka" target="_blank" rel="noopener noreferrer" title="LinkedIn" aria-label="LinkedIn">
